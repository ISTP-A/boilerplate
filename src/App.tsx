  ...
  return (
    <div className="max-w-screen-md py-20 mx-auto grid gap-8">
      ...
      <div className="grid grid-cols-2 gap-8">
        ...
        <div>
          <h2 className="mb-2">Where can I get some?</h2>
          <p>
